export function ZakaCodingLogo() {
  return (
    <span className="zaka-coding-logo-mark" role="img" aria-label="ZakaCoding">
      <svg
        className="w-7 mr-2 transform group-hover:-rotate-6 transition-transform"
        viewBox="0 0 512 512"
