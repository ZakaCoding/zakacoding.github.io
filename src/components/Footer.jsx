            ...
            <footer className="w-full px-4">
                <Row>
                    <Col className="mb-3" xs='12' md='6' lg='6'>
                        <div className="w-fit">
                            <a href="https://zakacoding.github.io" className='inline-flex items-center logo group'>
                                <svg className='w-7 mr-2 transform group-hover:-rotate-6 transition-transform' viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg className='w-7 dark:fill-white transition-transform group-hover:scale-110' viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="512" height="512" rx="50" className='fill-black dark:fill-white'/>
